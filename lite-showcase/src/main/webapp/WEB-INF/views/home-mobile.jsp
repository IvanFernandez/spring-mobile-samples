...
<html>
    <head>
        ...
        <!--        <link rel="stylesheet" type="text/css" href="..\css\jquery.mobile-1.1.1\jquery.mobile-1.1.1.min.css" />
                <link rel="stylesheet" type="text/css" href="..\css\jquery.mobile-1.1.1\jquery.mobile.structure-1.1.1.min.css" />
                <link rel="stylesheet" type="text/css" href="..\css\jquery.mobile-1.1.1\jquery.mobile.theme-1.1.1.min.css" />
